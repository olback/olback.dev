    ...
    <div class="container">
      <div class="main">
        ...
        <p style="font-size:100%">
          <i class="fa fa-google" style="color: blue;"></i> <a href="https://encrypted.google.com/">Google</a><br>
          ...
          <i class="fa fa-lock" style="color: green;"></i> <a href="https://lastpass.com/">Lastpass</a><br>
          <img src="./img/olback.jpg" alt="Image not found." width="16" height="16"> <a href="cheats" >olback's cheat </a><br>
          <i class="fa fa-google" style="color: blue;"></i> <a href="https://translate.google.com/"> Google Translate</a><br>
        </p>
      </div>
    </div>
  </div>
